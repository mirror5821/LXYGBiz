...
import com.lxyg.app.business.activity.ForgetPassActivity;
...
public class Forget1Fragment extends BaseFragment{
	...
	private void sub(String phone){
		ForgetPassActivity activity = (ForgetPassActivity)getActivity();
		activity.setPhone(phone);
		activity.setCode(mCode);
		activity.switchFragment(new Forget2Fragment());
	}
	...
	private void getCode(String phone){
		...
		AppHttpClient ac = new AppHttpClient(GET_CODE);
		ac.postData1(GET_CODE, new AppAjaxParam(jb), new onResultListener() {
