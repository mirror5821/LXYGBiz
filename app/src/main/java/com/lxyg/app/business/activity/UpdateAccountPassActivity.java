...
public class UpdateAccountPassActivity extends BaseActivity{
	...
	private OnKeyboardActionListener mOnKeyboardActionListener = new OnKeyboardActionListener(){
		...
		public void onRelease(int primaryCode){
			String str = mTv.getText().toString();
			if(str.length()==6){
				startActivity(new Intent(UpdateAccountPassActivity.this,TiXianInput2Activity.class).putExtra(INTENT_ID, str));
				finish(); 
				return;
			}else{
				str = str +Character.toString((char) primaryCode);
