...
public class Forget2Fragment extends BaseFragment{
	...
	private void sub(){
		final ForgetPassActivity activity = (ForgetPassActivity)getActivity();
		...
		AppHttpClient ac = new AppHttpClient(FORGET);
		ac.postData1(FORGET, new AppAjaxParam(jb), new onResultListener() {
